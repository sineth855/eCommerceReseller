              ...
              <v-data-table
                ...
                <td>
                  ...
                  <td>
                    ...
                    <v-chip v-else label small :color="getColorByStatus('danger')" text-color="white" >{{ "Inactive" }}</v-chip>
                  </td>
                  <td>
                    <v-btn @click="viewEdit(props.item.payment_method_id)" depressed outline icon fab dark color="primary" small>
...
<script>
  ...
  import {fetchList,updateData,deleteData} from '~/api/payment/paymentMethod'
  ...
  export default {
    data () {
      return {
        routeName: 'PaymentConfigurationForm',
        routeUrl: '/payment/payment_method',
        search: '',
        items: [],
        notifyStatus: '',
        message: '',
