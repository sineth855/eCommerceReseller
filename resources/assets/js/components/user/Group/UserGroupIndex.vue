            ...
            <v-card-text class="pa-0">
              <v-data-table
                ...
                <td>
                  ...
                  <td>
                    <v-btn @click="viewEdit(props.item.user_group_id)" depressed outline icon fab dark color="primary" small>
                      <v-icon>edit</v-icon>
                    </v-btn>
                    <v-btn @click="viewRoleEdit(props.item.user_group_id)" depressed outline icon fab dark color="primary" small>
...
<script>
  ...
  import {fetchList,updateData,deleteData} from '~/api/user/Group'
  ...
  export default {
    data () {
      return {
        routeName: 'UserGroupForm',
        routeUrl: '/user/user_group',
        search: '',
        items: [],
        notifyStatus: '',
        message: '',
    ...
    methods:{
      ...
      viewRoleEdit(id){
        this.$router.push(this.routeUrl+'/role/'+id)
      },
      createNew(){
