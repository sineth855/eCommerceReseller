            ...
            <v-card-text class="pa-0">
              <v-data-table
                ...
                <td>
                  ...
                  <td>
                    <v-btn @click="viewEdit(props.item.stock_status_id)" depressed outline icon fab dark color="primary" small>
                      <v-icon>edit</v-icon>
                    </v-btn>
                    <v-btn @click="btnConfirm(props.item.stock_status_id)"  depressed outline icon fab dark color="red" small>
...
<script>
  ...
  import {fetchList,updateData,deleteData} from '~/api/catalog/stockStatus'
  ...
  export default {
    data () {
      return {
        routeName: 'StockStatusForm',
        routeUrl: '/catalog/stock_status',
        search: '',
        items: [],
        notifyStatus: '',
        message: '',
